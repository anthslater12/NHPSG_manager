...
class BehaviourCheckpointTwoTests(unittest.TestCase):
    ...
    def test_weekly_route_places_exact_boundaries_in_correct_bands_and_counts(self):
        ...
        self.assertIn("Behaviour Weekly Review", page)
        self.assertIn("Monday", page)
        self.assertIn("3 Behaviour Episodes", page)
        self.assertIn("boundary-night", page)
        self.assertIn("boundary-day", page)
        self.assertIn("boundary-evening", page)
