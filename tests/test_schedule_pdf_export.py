...
class SchedulePdfExportTests(unittest.TestCase):
    ...
    def test_pdf_response_headers_filename_and_selected_client_html(self):
        ...
        self.assertIn('class="schedule-pdf-worker-time">10:00PM&ndash;5:00AM next day</span>', self.last_html)
        self.assertIn('class="schedule-pdf-worker-time">11:00PM&ndash;6:30AM next day</span>', self.last_html)
